                            ...
                            <tr class="fade-in" style="animation-delay: {{ $loop->index * 0.05 }}s;">
                                ...
                                <td>
                                    @if($carousel->image)
                                        <img src="{{ asset('storage/' . $carousel->image) }}" 
                                             ...
                                             data-bs-target="#imageModal{{ $carousel->id }}"
                                             style="cursor: zoom-in;">
                                        
                                        <!-- Modal pour agrandir l'image -->
                                        <div class="modal fade" id="imageModal{{ $carousel->id }}" tabindex="-1">
                                            <div class="modal-dialog modal-dialog-centered modal-lg">
                                                <div class="modal-content">
                                                    <div class="modal-header border-0">
                                                        <h5 class="modal-title">{{ $carousel->title }}</h5>
                                ...
                                <td>
                                    ...
                                    <form id="delete-form-{{ $carousel->id }}" 
                                          action="{{ route('admin.carousels.destroy', $carousel) }}" 
                                          method="POST" 
                                          class="d-none">
                                        @csrf
                                        @method('DELETE')
            ...
            <div class="card-footer">
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-center">
                    <div class="info-text mb-3 mb-md-0">
                        ...
                        <strong>{{ $carousels->count() }}</strong> slide{{ $carousels->count() > 1 ? 's' : '' }} enregistré{{ $carousels->count() > 1 ? 's' : '' }}
                    </div>
                    <div>
