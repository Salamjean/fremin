    ...
    <div class="partners-admin">
        <div class="partners-container">
            ...
            <div class="partners-header">
                <div class="partners-header-icon">
                    <i class="fas fa-handshake"></i>
                </div>
                <h1 class="partners-title">Nos Partenaires</h1>
                <p class="partners-subtitle">
                    Gérez la liste de vos partenaires et leurs informations
                </p>
            </div>
            ...
            <div class="partners-card">
                ...
                <div class="partners-actions">
                    <div class="stats-badge">
                        ...
                        <span>{{ $partners->count() }} partenaire{{ $partners->count() > 1 ? 's' : '' }}</span>
                    </div>
                    <a href="{{ route('admin.partners.create') }}" class="btn-add-partner">
                ...
                @if($partners->isEmpty())
                    <div class="empty-state">
                        ...
                        <h3 class="empty-title">Aucun partenaire</h3>
                        <p class="text-muted mb-4">Commencez par ajouter votre premier partenaire.</p>
                        <a href="{{ route('admin.partners.create') }}" class="btn-add-partner">
                            <i class="fas fa-plus"></i>
                            Ajouter maintenant
                        </a>
                            ...
                            <tbody>
                                @foreach($partners as $partner)
                                    <tr>
                                        ...
                                        <td>
                                            @if($partner->website)
                                                <a href="{{ $partner->website }}" target="_blank" class="website-link">
