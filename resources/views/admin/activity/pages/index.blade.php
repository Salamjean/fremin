...
@section('content')
    ...
    <style>
        .page-header {
            background: linear-gradient(135deg, #009B3A, #FF8200);
            color: white;
            padding: 2rem;
            border-radius: 16px;
            margin-bottom: 2rem;
    ...
    <div class="container-fluid py-4">
        <div class="page-header d-flex justify-content-between align-items-center">
            <div>
                <h2 class="mb-1">Gestion des Pages Activités</h2>
                <p class="mb-0">Gérez le contenu des pages d'activités (Etudes, Appuis, Cérémonies).</p>
            </div>
        </div>
                    ...
                    <div class="card h-100 page-card">
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="mt-auto pt-3 border-top">
                                <a href="{{ route('admin.activity-pages.edit', $page->id) }}"
