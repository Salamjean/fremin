        ...
        <div class="articles-card">
                        ...
                        <div class="article-content">
                            ...
                            <div class="article-footer">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <span class="article-status {{ $article->is_active ? 'status-active' : 'status-inactive' }}">
            ...
            <div class="articles-footer">
                <div class="articles-stats-info">
                    ...
                    <div class="stats-item">
                        <i class="fas fa-eye"></i>
                        <span><span class="stats-value">{{ $articles->where('is_active', true)->count() }}</span> active{{ $articles->where('is_active', true)->count() > 1 ? 's' : '' }}</span>
                    </div>
                    <div class="stats-item">
                        <i class="fas fa-chart-line"></i>
                        <span><span class="stats-value">{{ number_format($articles->sum('views'), 0, ',', ' ') }}</span> vues totales</span>
                    </div>
                </div>
