...
<div class="prog-form-container">
    <div class="form-card">
        <div class="form-header">
            <h1 class="form-title">{{ isset($project) ? 'Modifier le Projet' : 'Nouveau Projet' }}</h1>
        </div>
        ...
        <form action="{{ isset($project) ? route('admin.projects.update', $project) : route('admin.projects.store') }}"
            ...
            <div class="form-section">
                <h3 class="section-title"><i class="fas fa-image"></i> Visuel du Projet</h3>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="type" class="form-select" required>
                                <option value="" disabled {{ !isset($project) ? 'selected' : '' }}>Choisir...</option>
                                <option value="aed" {{ (old('type', $project->type ?? '') == 'aed') ? 'selected' : '' }}>
                                    AED</option>
                                <option value="zone" {{ (old('type', $project->type ?? '') == 'zone') ? 'selected' : '' }}>Zone Industrielle</option>
                                <option value="autre" {{ (old('type', $project->type ?? '') == 'autre') ? 'selected' : '' }}>Autre</option>
                            </select>
                        </div>
                    </div>
                </div>
