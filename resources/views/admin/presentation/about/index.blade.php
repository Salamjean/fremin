...
@section('content')
    ...
    <style>
        ...
        .section-card:hover .section-sort-order {
                    ...
                    <div class="about-grid" id="aboutGrid">
                        @foreach($aboutSections as $about)
                            <div class="section-card {{ $about->is_active ? 'active' : '' }}"
                                data-sort-order="{{ $about->sort_order }}" data-active="{{ $about->is_active ? 'true' : 'false' }}">
                                ...
                                <div class="section-content">
                                    ...
                                    @if($about->main_image)
                                        <div class="image-container">
                                            <img src="{{ asset('storage/' . $about->main_image) }}"
                                                alt="{{ $about->main_image_alt ?? 'Section About' }}" class="section-image">
                                        </div>
                                    @else
                                    ...
                                    <div class="section-meta">
                                        ...
                                        <div class="section-actions">
                                            ...
                                            <form action="{{ route('admin.about.toggle-status', $about) }}" method="POST"
                                            ...
                                            <form action="{{ route('admin.about.destroy', $about) }}" method="POST"
                                                ...
                                                <button type="button" class="btn-action btn-delete delete-btn"
                                                    data-title="{{ $about->section_title ?? 'Cette section' }}" title="Supprimer">
                    ...
                    <div class="about-footer">
                        <div class="about-stats-info">
                            <div class="stats-item">
                                <i class="fas fa-layer-group"></i>
                                <span><span class="stats-value">{{ $aboutSections->count() }}</span>
                                    section{{ $aboutSections->count() > 1 ? 's' : '' }}</span>
                            </div>
                            <div class="stats-item">
                                <i class="fas fa-eye"></i>
                                <span><span class="stats-value">{{ $aboutSections->where('is_active', true)->count() }}</span>
                                    active{{ $aboutSections->where('is_active', true)->count() > 1 ? 's' : '' }}</span>
                            </div>
                        </div>
