                        ...
                        <div class="image-container">
                            @if($gallery->image)
                                <img src="{{ asset('storage/' . $gallery->image) }}" 
                                     alt="{{ $gallery->image_alt ?? $gallery->caption_title }}" 
                                     class="gallery-image"
                            ...
                            @if($gallery->image)
                                <button type="button" 
                                        class="preview-btn preview-image-btn"
                                        data-image="{{ asset('storage/' . $gallery->image) }}"
                                        data-caption="{{ $gallery->caption_title }}"
                                ...
                                <div class="image-actions">
                                    ...
                                    <form action="{{ route('admin.gallery.destroy', $gallery) }}" 
                                        ...
                                        <button type="button" 
                                                ...
                                                data-title="{{ $gallery->caption_title ?? $gallery->title }}"
                                                data-image="{{ $gallery->image ? 'oui' : 'non' }}"
                                                title="Supprimer">
            ...
            <div class="gallery-footer">
                <div class="gallery-stats-info">
                    <div class="stats-item">
                        <i class="fas fa-images"></i>
                        <span><span class="stats-value">{{ $galleries->count() }}</span> image{{ $galleries->count() > 1 ? 's' : '' }}</span>
                    </div>
                    <div class="stats-item">
                        <i class="fas fa-eye"></i>
                        <span><span class="stats-value">{{ $galleries->where('is_active', true)->count() }}</span> active{{ $galleries->where('is_active', true)->count() > 1 ? 's' : '' }}</span>
                    </div>
                </div>
