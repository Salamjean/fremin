                                ...
                                <div class="col-lg-5">
                                    <div class="agro-content-box">
                                        ...
                                        <p>Les clusters sont des ensembles d’unités industriels regroupés autour d’un
                                            ...
                                            Il s’agit notamment des clusters de la <strong>chimie et plasturgie, des
                                                matériaux de
                                                construction, d’ameublement et d’équipement, de l’emballage, de
                                                l’agro-industrie
                                ...
                                <div class="col-lg-7">
                                    <div class="agro-gallery">
                                        ...
                                        <div class="agro-img-sub">
                                            <img src="{{ asset('assets/img/csm_Fruits_seches_ad043c787a.jpeg') }}"
                                                alt="Remise équipements 2">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="agro-slide-card">
                            <div class="row align-items-center g-0">
                                ...
                                <div class="col-lg-7">
                                    <div class="agro-gallery">
                                        <div class="agro-img-main">
                                            <img src="{{ asset('assets/img/actu_image_37702_maxi2.jpg.jpeg') }}"
                                                alt="Tricycles 1">
                                        </div>
                                        <div class="agro-img-sub">
                                            <img src="{{ asset('assets/img/jad20230605-eco-civ-transformation-noix-cajou-1256x628-1685981432.avif') }}" alt="Tricycles 2">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="agro-slide-card">
                            <div class="row align-items-center g-0">
                                ...
                                <div class="col-lg-7">
                                    <div class="agro-gallery">
                                        <div class="agro-img-main">
                                            <img src="{{ asset('assets/img/galerie176588060124.jpg.jpeg') }}"
                                                alt="Tricycles 1">
                                        </div>
                                        <div class="agro-img-sub">
                            ...
                            <div class="row align-items-center g-0">
                                ...
                                <div class="col-lg-7">
                                    <div class="agro-gallery">
                                        ...
                                        <div class="agro-img-sub">
                                            <img src="{{ asset('assets/img/ffffffff.jpeg') }}"
                                                alt="Tricycles 2">
                                        </div>
                                    </div>
                                </div>
