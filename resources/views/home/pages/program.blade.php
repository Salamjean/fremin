            ...
            <div class="row g-4">
                @forelse($programs as $program)
                    <div class="col-md-6 col-lg-4">
                        <div class="program-card {{ $loop->first ? 'program-premium' : '' }}">
                            @if($loop->first)
                            ...
                            <div class="program-category mb-2 text-primary fw-bold">{{ $program->subtitle }}</div>
        ...
        <div class="container">
            ...
            <div class="row g-4">
                @forelse($opportunities as $opportunity)
                    <div class="col-lg-6">
                        <div class="call-card {{ $opportunity->status == 'open' ? 'call-urgent' : '' }}">
                            <div class="call-header">
                                <div class="call-status">
                                    <span
                                        class="status-badge {{ $opportunity->status == 'open' ? 'open' : ($opportunity->status == 'closed' ? 'urgent' : '') }}">
                                        <i
                                            class="fas {{ $opportunity->status == 'open' ? 'fa-hourglass-half' : 'fa-exclamation-circle' }} me-1"></i>
                                        {{ $opportunity->status == 'open' ? 'Ouvert' : ($opportunity->status == 'closed' ? 'Clôturé' : 'À venir') }}
                                    </span>
                                </div>
                                @if($opportunity->deadline)
                                    <div class="call-date">
                                        <span class="date-day">{{ $opportunity->deadline->format('d') }}</span>
                                        <span
                                            class="date-month">{{ strtoupper($opportunity->deadline->translatedFormat('M')) }}</span>
                                        <span class="date-year">{{ $opportunity->deadline->format('Y') }}</span>
                                    </div>
                                @endif
                            </div>
                            <h3 class="call-title">{{ $opportunity->title }}</h3>
                            <p class="call-description">
                                {{ Str::limit(strip_tags($opportunity->description), 200) }}
                            </p>
                            <div class="call-details">
                                <div class="detail">
                                    ...
                                    <div>
                                        ...
                                        <span class="detail-value">{{ $opportunity->type }}</span>
                                    </div>
                                </div>
                                <div class="detail">
                                    ...
                                    <div>
                                        ...
                                        <span class="detail-value">{{ $opportunity->location ?: 'Non spécifié' }}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="call-footer">
                                <a href="{{ $opportunity->link ?: '#' }}" class="btn btn-primary">
                                    <i class="fas fa-file-alt me-2"></i> {{ $opportunity->link_text ?: 'Postuler maintenant' }}
                                </a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="accordion quick-accordion" id="quickFaq">
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="faq1" class="accordion-collapse collapse show" data-bs-parent="#quickFaq">
                                    <div class="accordion-body">
                                        Le traitement complet d'un dossier prend généralement 30 à 45 jours ouvrables après
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="faq2" class="accordion-collapse collapse" data-bs-parent="#quickFaq">
                                    <div class="accordion-body">
                                        Non, la soumission de dossier est entièrement gratuite. Le FREMIN ne facture aucun
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="faq3" class="accordion-collapse collapse" data-bs-parent="#quickFaq">
                                    <div class="accordion-body">
                                        Oui, une entreprise peut postuler à plusieurs programmes simultanément, mais ne peut
                                        bénéficier que d'un seul programme à la fois.
                                    </div>
                                </div>
                            </div>
                        </div>
