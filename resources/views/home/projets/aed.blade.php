            ...
            <div class="tab-content pt-2" id="aedTabContent">
                ...
                <div class="tab-pane fade show active" id="presentation" role="tabpanel" aria-labelledby="presentation-tab">
                    <div class="content-box-premium mb-4" data-aos="fade-up">
                        <h3 class="section-title" style="color: #009B3A; font-weight: 800; margin-bottom: -50px;">Contexte &
                            Présentation</h3>
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="media-card rounded-4 overflow-hidden position-relative shadow-sm"
                                        style="height: 420px;">
                                        <img src="{{ asset('assets/img/1.jpg') }}" alt="AED 1"
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="media-card rounded-4 overflow-hidden position-relative shadow-sm"
                                        style="height: 200px;">
                                        <img src="{{ asset('assets/img/2.jpg') }}" alt="AED 2"
                                            class="w-100 h-100 object-fit-cover transition-transform">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="media-card rounded-4 overflow-hidden position-relative shadow-sm"
                                        style="height: 200px;">
                                        <img src="{{ asset('assets/img/3.jpg') }}" alt="AED 3"
                                            class="w-100 h-100 object-fit-cover transition-transform">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="media-card rounded-4 overflow-hidden position-relative shadow-sm"
                                        style="height: 200px;">
                                        <img src="{{ asset('assets/img/4.jpg') }}" alt="AED 4"
                                            class="w-100 h-100 object-fit-cover transition-transform">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-8 col-md-12">
                                    <div class="media-card rounded-4 overflow-hidden position-relative shadow-sm"
                                        style="height: 300px;">
                                        <img src="{{ asset('assets/img/5.jpg') }}" alt="AED Groupe"
                                            class="w-100 h-100 object-fit-cover transition-transform">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="media-card rounded-4 overflow-hidden position-relative shadow-sm"
                                        style="height: 300px;">
                                        <img src="{{ asset('assets/img/6.jpg') }}" alt="AED 5"
                                            class="w-100 h-100 object-fit-cover transition-transform">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3 col-md-6">
                                    <div class="media-card rounded-4 overflow-hidden position-relative shadow-sm"
                                        style="height: 250px;">
                                        <img src="{{ asset('assets/img/7.jpg') }}" alt="AED 6"
                                            class="w-100 h-100 object-fit-cover transition-transform">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3 col-md-6">
                                    <div class="media-card rounded-4 overflow-hidden position-relative shadow-sm"
                                        style="height: 250px;">
                                        <img src="{{ asset('assets/img/8.jpg') }}" alt="AED 7"
                                            class="w-100 h-100 object-fit-cover transition-transform">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3 col-md-6">
                                    <div class="media-card rounded-4 overflow-hidden position-relative shadow-sm"
                                        style="height: 250px;">
                                        <img src="{{ asset('assets/img/9.jpg') }}" alt="AED 8"
                                            class="w-100 h-100 object-fit-cover transition-transform">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3 col-md-6">
                                    <div class="media-card rounded-4 overflow-hidden position-relative shadow-sm"
                                        style="height: 250px;">
                                        <img src="{{ asset('assets/img/10.jpg') }}" alt="AED 9"
                                            class="w-100 h-100 object-fit-cover transition-transform">
                                    </div>
                                </div>
                            </div>
